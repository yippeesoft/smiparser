...
notificationtype_macro[IdToken idToken] returns [SmiOidMacro v = null]
{
	v = m_mp.createOidMacro(idToken);
}
:
	"NOTIFICATION-TYPE"
	("OBJECTS" L_BRACE notification_reference[v] (COMMA notification_reference[v])* R_BRACE)? 
	"STATUS" status_v2
	"DESCRIPTION" C_STRING ("REFERENCE" C_STRING)?	
{
...
notification_reference[SmiOidMacro sequenceType] 
:
	l: LOWER
{
	 m_mp.addReference(sequenceType,l);
}
;
